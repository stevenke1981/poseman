...
- **擬人化人偶**：分層頭臉（眼白／虹膜／眉毛／鼻／嘴／耳／下巴）、髮型輪廓、手指與拇指、鞋底、四肢錐度與小腿曲線，男／女體型
- **人物外觀**：目前人物可調整膚色與服裝配色風格（靛藍／陶土／鼠尾草／石墨）；設定會跟人物一起自動保存並包含在場景 JSON
...
- **選取狀態**：面板顯示「目前選取」；人物橘色 bounding box、物品藍色 bounding box
...
- 無後端、無其他執行期依賴；人偶與物品以程序化幾何體建構，幾何可共享快取；人偶外觀材質則按人物獨立建立，避免改色互相污染
